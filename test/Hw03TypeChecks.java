...
public class Hw03TypeChecks {
  /**
   * takes in arguments to check if the constructors have the correct and right number of args.
   * @param args that are being checked to make sure we are sure main can compile
   */
